...
test( 'Add item to cart', async({page, browser})=>
{
await page.goto(" https://test1-cdn.olivegarden.com/menu");
await page.locator('#onetrust-accept-btn-handler').click();
await page.on('dialog' , dialog=> dialog.accept());
...
test( 'Checkout', async({page, browser})=>
{
await page.goto(" https://test1-cdn.olivegarden.com/menu");
await page.locator('#onetrust-accept-btn-handler').click();
await page.on('dialog' , dialog=> dialog.accept());
...
await page.locator('#id1773344315').fill('Sharad');
await page.locator('#id-337012267').fill('Singh');
await page.locator('#id67066748').fill('sharad-kumar.singh@capgemini.com');
...
test( 'Place Order', async({page, browser})=>
{
await page.goto(" https://test1-cdn.olivegarden.com/menu");
await page.locator('#onetrust-accept-btn-handler').click();
await page.on('dialog' , dialog=> dialog.accept());
